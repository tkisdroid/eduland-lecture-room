...
import { lectureContentData } from "@/data/lectureContent";
...
export const LectureTabs = () => {
  ...
  // TODO: This should be dynamically fetched based on current lecture ID
  const { strategyContent, summaryContent, quizQuestions } = lectureContentData;
